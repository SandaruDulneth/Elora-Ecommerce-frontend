...
export default function AboutPage() {
    ...
    return (
        <div className="snap-y snap-mandatory overflow-y-scroll h-screen">
            ...
            {/* SECTION 2 */}
            <section className="snap-start w-screen h-full bg-[url('/bg02.jpg')] bg-center bg-cover flex justify-center items-center">
                <div className="w-screen h-screen backdrop-blur-md flex flex-col font-light">
                    <div
                        ref={sectionTwoRef}
                        className={`text-white text-left py-20 px-4 transition-all duration-1000 ease-out
